...
# ---------- Load the image ----------
image_path = 'flowers.png'  # Replace with your file
...
# ---------- Display Images ----------
cv2.imshow("Original CS24199", image)
cv2.imshow("Lossy JPEG CS24199", cv2.imread(lossy_output))
cv2.imshow("Lossless PNG CS24199", cv2.imread(lossless_output))
cv2.waitKey(0)
