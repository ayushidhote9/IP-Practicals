...
def detect_object(template_path, input_image_path):
    ...
    cv2.imshow('Detected Objects CS24191', img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()

# Provide the paths to the template and input images
template_path = r'C:\Users\Ayushi Dhote\PycharmProjects\PythonProject1\tofind.png'
input_image_path = r'C:\Users\Ayushi Dhote\PycharmProjects\PythonProject1\gamesA.png'
